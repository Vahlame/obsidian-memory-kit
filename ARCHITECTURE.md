...
| `evals/`                             | Node / YAML | Prompt-adherence gate run in CI                                       |
...
- **Quality gates:** `scripts/check-es-en-parity.mjs` (bilingual doc drift), `scripts/mcp-smoke.mjs`, and the `evals/` prompt-adherence suite.
...
| Bilingual parity   | `node scripts/check-es-en-parity.mjs`       |
| Links              | `npx lychee .`                              |
